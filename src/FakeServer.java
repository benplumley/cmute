...
public class FakeServer {
    ...
    public Ride[] getMatchingRides(Boolean isToUni, DateTime dateAndTime, int timeTolerance) {
        ...
        if (isToUni) {
            ...
            Ride[] result = {new Ride(false, new MapPoint(52,99), new DateTime(1459183241000L),zero,four,four),
                             new Ride(false, new MapPoint(253,102), new DateTime(1459189641000L),zero,four,four),
                             new Ride(false, new MapPoint(652,400), new DateTime(1459189641000L),zero,four,four),
                             new Ride(false, new MapPoint(670,48), new DateTime(1459189641000L), zero,four,four)};
            return result;
        }
    }
